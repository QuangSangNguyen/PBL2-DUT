...
public:
    calendar(int month = 11, int year = 2022)
    {
        this->month = month;
        this->year = year;
    }
    ...
    int showCalendar(int month, int year = 2022)
    {
        // int red = 67, black = 37;
        int red = 12, black = 10;
    ...
    void bookAppointment()
    {
        ...
        do
        {
            ...
            cout << endl;
            x = getDateInput("Which date do you want to schedule a medical appointment? ", month, year);
            if (isFreeDate(x, month, year) == -1)
            {
                addNewDayToDataBase(x, month, year, 10);
